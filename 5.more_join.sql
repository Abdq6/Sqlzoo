...
JOIN casting ON (movieid=movie.id AND actorid=(SELECT id FROM actor WHERE name='Art Garfunkel'))
JOIN actor ON actorid=actor.id) AND actorid!=(SELECT id FROM actor WHERE name='Art Garfunkel')